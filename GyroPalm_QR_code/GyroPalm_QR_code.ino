...
void showApp(int page) {
    ...
    switch (page)
    {
		case SCR_HOME:
        {
            ...
            /*Create a 150x150 QR code*/
            lv_obj_t * qr = lv_qrcode_create(form[curScreen]._screen, 150, lv_color_hex3(0x018), lv_color_hex3(0xeef));

            /*Set data*/
            lv_qrcode_update(qr, qrString.c_str(), strlen(qrString.c_str()));
            
            /*Align to the center of screen*/
            lv_obj_align(qr, NULL, LV_ALIGN_CENTER, 0, 35);
